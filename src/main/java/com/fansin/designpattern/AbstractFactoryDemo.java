...
class UnionPayAttendanceTransStatistics extends UnionPayTransStatistics{
    ...
    public UnionPayAttendanceTransStatistics(long lastTransNum, long lastTransAmt, long nowTransNum, long nowTransAmt, long loanBankNum, long acquirerNum) {
...
class UnionPayClerkTransStatistics extends UnionPayTransStatistics{
    ...
    public UnionPayClerkTransStatistics(long lastTransNum, long lastTransAmt, long nowTransNum, long nowTransAmt, long loanBankNum, long acquirerNum) {
        super(lastTransNum, lastTransAmt, nowTransNum, nowTransAmt, loanBankNum, acquirerNum);
        this.status = "已启用";
    }
...
class UnionPayLeaderTransStatistics extends UnionPayTransStatistics{
    ...
    public UnionPayLeaderTransStatistics(long lastTransNum, long lastTransAmt, long nowTransNum, long nowTransAmt, long loanBankNum, long acquirerNum) {
        super(lastTransNum, lastTransAmt, nowTransNum, nowTransAmt, loanBankNum, acquirerNum);
    }
}
